...
import 'beli.dart'; // Import file beli.dart
import 'keranjang.dart'; // Import file Keranjang.dart
...
class DP1Page extends StatefulWidget {
  @override
  _DP1PageState createState() => _DP1PageState();
}

class _DP1PageState extends State<DP1Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 350000;
  final int _pricee = 350000;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        _navigateToBeliPage(_quantity, _quantity * _price);
                      },
                      child: Text('Checkout'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blue, // warna background
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeliPage(int quantity, int totalPrice) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            BeliPage(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }

  void _navigateToKeranjangPage(int quantityy, int totalPricee) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            KeranjangPage(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah deskripsi produk yang lengkap. Paket Pancing Komplit ini mencakup semua yang Anda butuhkan untuk memancing, termasuk joran, reel, senar, dan berbagai macam umpan.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
