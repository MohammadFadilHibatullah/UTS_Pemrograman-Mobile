...
import 'beli3.dart'; // Import file beli.dart
import 'keranjang3.dart'; // Import file Keranjang2.dart
...
class DP3Page extends StatefulWidget {
  @override
  _DP3PageState createState() => _DP3PageState();
}

class _DP3PageState extends State<DP3Page> {
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli3Page(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            Beli3Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage3(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            Keranjang3Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Kail pancing ini dirancang khusus untuk membantumu mendapatkan hasil tangkapan maksimal. Terbuat dari bahan kuat dan tahan karat, kail ini tajam dan tidak mudah bengkok, sehingga siap menemani petualangan memancingmu di berbagai kondisi air.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
