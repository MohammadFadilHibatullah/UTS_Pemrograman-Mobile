...
import 'beli4.dart'; // Import file beli.dart
import 'keranjang4.dart'; // Import file Keranjang2.dart
...
class DP4Page extends StatefulWidget {
  @override
  _DP4PageState createState() => _DP4PageState();
}

class _DP4PageState extends State<DP4Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 80000;
  final int _pricee = 80000;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        _navigateToBeli4Page(_quantity, _quantity * _price);
                      },
                      child: Text('Checkout'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blue, // warna background
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli4Page(int quantity, int totalPrice) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Beli4Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }

  void _navigateToKeranjangPage4(int quantityy, int totalPricee) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Keranjang4Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Rasakan sensasi memancing yang klasik dan otentik dengan joran pancing kayu! Dibuat dengan ketrampilan dan ketelitian dari pengrajin handal, joran pancing kayu ini bukan hanya kuat dan tahan lama, tetapi juga indah dan penuh gaya.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
