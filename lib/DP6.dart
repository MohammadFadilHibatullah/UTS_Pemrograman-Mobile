...
import 'beli6.dart'; // Import file beli.dart
import 'keranjang6.dart'; // Import file Keranjang2.dart
...
class DP6Page extends StatefulWidget {
  @override
  _DP6PageState createState() => _DP6PageState();
}

class _DP6PageState extends State<DP6Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 90000;
  final int _pricee = 90000;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        _navigateToBeli6Page(_quantity, _quantity * _price);
                      },
                      child: Text('Checkout'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blue, // warna background
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli6Page(int quantity, int totalPrice) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Beli6Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }

  void _navigateToKeranjangPage6(int quantityy, int totalPricee) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Keranjang6Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tabung pancing adalah wadah yang dirancang khusus untuk menyimpan joran pancing. Tabung pancing terbuat dari bahan yang kuat dan tahan lama, seperti plastik, fiberglass, atau aluminium. Tabung pancing tersedia dalam berbagai ukuran untuk menampung berbagai jenis joran pancing.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
