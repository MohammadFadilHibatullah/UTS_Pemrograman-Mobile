...
import 'beli7.dart'; // Import file beli.dart
import 'keranjang7.dart'; // Import file Keranjang2.dart
...
class DP7Page extends StatefulWidget {
  @override
  _DP7PageState createState() => _DP7PageState();
}

class _DP7PageState extends State<DP7Page> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        _navigateToBeli7Page(_quantity, _quantity * _price);
                      },
                      child: Text('Checkout'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blue, // warna background
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli7Page(int quantity, int totalPrice) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Beli7Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }

  void _navigateToKeranjangPage7(int quantityy, int totalPricee) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Keranjang7Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Umpan pancing adalah salah satu faktor terpenting dalam menangkap ikan. Umpan pancing yang tepat dapat menarik perhatian ikan dan meningkatkan peluang Anda untuk mendapatkan hasil tangkapan maksimal.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
