...
import 'beli8.dart'; // Import file beli.dart
import 'keranjang8.dart'; // Import file Keranjang2.dart
...
class DP8Page extends StatefulWidget {
  @override
  _DP8PageState createState() => _DP8PageState();
}

class _DP8PageState extends State<DP8Page> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        _navigateToBeli8Page(_quantity, _quantity * _price);
                      },
                      child: Text('Checkout'),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.blue, // warna background
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli8Page(int quantity, int totalPrice) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Beli8Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }

  void _navigateToKeranjangPage8(int quantityy, int totalPricee) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            Keranjang8Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tabung pancing variasi hadir dengan berbagai pilihan model dan desain yang menarik, tidak hanya berfungsi untuk melindungi joran pancing Anda, tetapi juga menambah gaya dalam petualangan memancing Anda.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
