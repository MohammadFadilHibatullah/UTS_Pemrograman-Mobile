...
import 'belii2.dart'; // Import file beli.dart
import 'keranjangi2.dart'; // Import file Keranjang2.dart
...
class DPI2Page extends StatefulWidget {
  @override
  _DPI2PageState createState() => _DPI2PageState();
}

class _DPI2PageState extends State<DPI2Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 34000;
  final int _pricee = 34000;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('assets/ikan_2.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeliPage2(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            BeliI2Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage2(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            KeranjangI2Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah ikan lele yang berkualitas dan fresh.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
