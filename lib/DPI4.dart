...
import 'belii4.dart'; // Import file beli.dart
import 'keranjangi4.dart'; // Import file Keranjang2.dart
...
class DPI4Page extends StatefulWidget {
  @override
  _DPI4PageState createState() => _DPI4PageState();
}

class _DPI4PageState extends State<DPI4Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 33000;
  final int _pricee = 33000;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('assets/ikan_4.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli4Page(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            BeliI4Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage4(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            KeranjangI4Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah ikan patin yang berkualitas dan fresh.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
