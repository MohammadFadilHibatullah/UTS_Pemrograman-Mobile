...
import 'belii5.dart'; // Import file beli.dart
import 'keranjangi5.dart'; // Import file Keranjang2.dart
...
class DPI5Page extends StatefulWidget {
  @override
  _DPI5PageState createState() => _DPI5PageState();
}

class _DPI5PageState extends State<DPI5Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 60000;
  final int _pricee = 60000;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('assets/ikan_5.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli5Page(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            BeliI5Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage5(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            KeranjangI5Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah ikan mas yang berkualitas dan fresh.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
