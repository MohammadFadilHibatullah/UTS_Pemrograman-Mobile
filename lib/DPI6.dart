...
import 'belii6.dart'; // Import file beli.dart
import 'keranjangi6.dart'; // Import file Keranjang2.dart
...
class DPI6Page extends StatefulWidget {
  @override
  _DPI6PageState createState() => _DPI6PageState();
}

class _DPI6PageState extends State<DPI6Page> {
  final PageController _pageController = PageController();
  int _currentPage = 0;
  int _selectedIndex = 0;
  int _quantity = 1;
  int _quantityy = 1;
  final int _price = 51000;
  final int _pricee = 51000;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('assets/ikan_6.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli6Page(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            BeliI6Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage6(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            KeranjangI6Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah ikan kakap yang berkualitas dan fresh.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
