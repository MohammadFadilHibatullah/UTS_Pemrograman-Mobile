...
import 'belii8.dart'; // Import file beli.dart
import 'keranjangi8.dart'; // Import file Keranjang2.dart
...
class DPI8Page extends StatefulWidget {
  @override
  _DPI8PageState createState() => _DPI8PageState();
}

class _DPI8PageState extends State<DPI8Page> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage('assets/ikan_8.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
...
// Function to navigate to Beli.dart with parameters
  void _navigateToBeli8Page(int quantity, int totalPrice) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            BeliI8Page(quantity: quantity, totalPrice: totalPrice),
      ),
    );
  }
  ...
  void _navigateToKeranjangPage8(int quantityy, int totalPricee) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            KeranjangI8Page(quantityy: quantityy, totalPricee: totalPricee),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Ini adalah ikan bawal yang berkualitas dan fresh.',
                      style: TextStyle(
                        fontSize: 14,
                      ),
                    ),
