...
class Keranjangi1Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjangi1Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjangi1PageState createState() => _Keranjangi1PageState();
}

class _Keranjangi1PageState extends State<Keranjangi1Page> {
  int totalItems = 0;
  double totalPrice = 0;
