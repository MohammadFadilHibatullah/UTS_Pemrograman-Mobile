...
import 'notif2.dart'; // Import dialog notifikasi

class Beli2Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli2Page({required this.quantity, required this.totalPrice});

  @override
  _Beli2PageState createState() => _Beli2PageState();
}

class _Beli2PageState extends State<Beli2Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation2Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
