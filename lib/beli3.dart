...
import 'notif3.dart'; // Import dialog notifikasi

class Beli3Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli3Page({required this.quantity, required this.totalPrice});

  @override
  _Beli3PageState createState() => _Beli3PageState();
}

class _Beli3PageState extends State<Beli3Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation3Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
