...
import 'notif4.dart'; // Import dialog notifikasi

class Beli4Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli4Page({required this.quantity, required this.totalPrice});

  @override
  _Beli4PageState createState() => _Beli4PageState();
}

class _Beli4PageState extends State<Beli4Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation4Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
