...
import 'notif5.dart'; // Import dialog notifikasi

class Beli5Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli5Page({required this.quantity, required this.totalPrice});

  @override
  _Beli5PageState createState() => _Beli5PageState();
}

class _Beli5PageState extends State<Beli5Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation5Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
