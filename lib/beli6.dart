...
import 'notif6.dart'; // Import dialog notifikasi

class Beli6Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli6Page({required this.quantity, required this.totalPrice});

  @override
  _Beli6PageState createState() => _Beli6PageState();
}

class _Beli6PageState extends State<Beli6Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation6Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
