...
import 'notif7.dart'; // Import dialog notifikasi

class Beli7Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  Beli7Page({required this.quantity, required this.totalPrice});

  @override
  _Beli7PageState createState() => _Beli7PageState();
}

class _Beli7PageState extends State<Beli7Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return Confirmation7Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
