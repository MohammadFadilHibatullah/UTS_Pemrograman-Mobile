...
import 'notifi1.dart'; // Import dialog notifikasi

class BeliIPage extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliIPage({required this.quantity, required this.totalPrice});

  @override
  _BeliIPageState createState() => _BeliIPageState();
}

class _BeliIPageState extends State<BeliIPage> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationIDialog(totalPayment: totalPayment);
                      },
                    );
                  },
