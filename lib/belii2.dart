...
import 'notifi2.dart'; // Import dialog notifikasi

class BeliI2Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI2Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI2PageState createState() => _BeliI2PageState();
}

class _BeliI2PageState extends State<BeliI2Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI2Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
