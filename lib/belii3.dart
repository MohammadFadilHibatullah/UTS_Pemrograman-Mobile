...
import 'notifi3.dart'; // Import dialog notifikasi

class BeliI3Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI3Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI3PageState createState() => _BeliI3PageState();
}

class _BeliI3PageState extends State<BeliI3Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI3Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
