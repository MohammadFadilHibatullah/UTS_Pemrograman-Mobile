...
import 'notifi4.dart'; // Import dialog notifikasi

class BeliI4Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI4Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI4PageState createState() => _BeliI4PageState();
}

class _BeliI4PageState extends State<BeliI4Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI4Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
