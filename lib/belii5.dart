...
import 'notifi5.dart'; // Import dialog notifikasi

class BeliI5Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI5Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI5PageState createState() => _BeliI5PageState();
}

class _BeliI5PageState extends State<BeliI5Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI5Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
