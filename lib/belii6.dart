...
import 'notifi6.dart'; // Import dialog notifikasi

class BeliI6Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI6Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI6PageState createState() => _BeliI6PageState();
}

class _BeliI6PageState extends State<BeliI6Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI6Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
