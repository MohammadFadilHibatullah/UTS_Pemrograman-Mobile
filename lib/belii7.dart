...
import 'notifi7.dart'; // Import dialog notifikasi

class BeliI7Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI7Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI7PageState createState() => _BeliI7PageState();
}

class _BeliI7PageState extends State<BeliI7Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI7Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
