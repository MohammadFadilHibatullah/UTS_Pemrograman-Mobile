...
import 'notifi8.dart'; // Import dialog notifikasi

class BeliI8Page extends StatefulWidget {
  final int quantity;
  final int totalPrice;

  BeliI8Page({required this.quantity, required this.totalPrice});

  @override
  _BeliI8PageState createState() => _BeliI8PageState();
}

class _BeliI8PageState extends State<BeliI8Page> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationI8Dialog(totalPayment: totalPayment);
                      },
                    );
                  },
