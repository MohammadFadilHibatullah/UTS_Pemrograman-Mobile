...
import 'KB.dart'; // Impor file KB.dart

class Keranjang2Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang2Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang2PageState createState() => _Keranjang2PageState();
}

class _Keranjang2PageState extends State<Keranjang2Page> {
  int totalItems = 0;
  double totalPrice = 0;
  ...
  void _navigateToPaymentPage(List<Map<String, dynamic>> selectedItems) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PaymentPage(items: selectedItems),
      ),
    );
  }
