...
class Keranjang3Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang3Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang3PageState createState() => _Keranjang3PageState();
}

class _Keranjang3PageState extends State<Keranjang3Page> {
  int totalItems = 0;
  double totalPrice = 0;
