...
class Keranjang4Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang4Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang4PageState createState() => _Keranjang4PageState();
}

class _Keranjang4PageState extends State<Keranjang4Page> {
  int totalItems = 0;
  double totalPrice = 0;
