...
class Keranjang5Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang5Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang5PageState createState() => _Keranjang5PageState();
}

class _Keranjang5PageState extends State<Keranjang5Page> {
  int totalItems = 0;
  double totalPrice = 0;
