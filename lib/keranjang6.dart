...
class Keranjang6Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang6Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang6PageState createState() => _Keranjang6PageState();
}

class _Keranjang6PageState extends State<Keranjang6Page> {
  int totalItems = 0;
  double totalPrice = 0;
