...
class Keranjang7Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang7Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang7PageState createState() => _Keranjang7PageState();
}

class _Keranjang7PageState extends State<Keranjang7Page> {
  int totalItems = 0;
  double totalPrice = 0;
