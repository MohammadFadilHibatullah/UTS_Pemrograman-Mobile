...
class Keranjang8Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  Keranjang8Page({required this.quantityy, required this.totalPricee});

  @override
  _Keranjang8PageState createState() => _Keranjang8PageState();
}

class _Keranjang8PageState extends State<Keranjang8Page> {
  int totalItems = 0;
  double totalPrice = 0;
