...
class KeranjangI2Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI2Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI2PageState createState() => _KeranjangI2PageState();
}

class _KeranjangI2PageState extends State<KeranjangI2Page> {
  int totalItems = 0;
  double totalPrice = 0;
