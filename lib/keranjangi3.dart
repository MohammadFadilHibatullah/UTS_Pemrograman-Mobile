...
class KeranjangI3Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI3Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI3PageState createState() => _KeranjangI3PageState();
}

class _KeranjangI3PageState extends State<KeranjangI3Page> {
  int totalItems = 0;
  double totalPrice = 0;
