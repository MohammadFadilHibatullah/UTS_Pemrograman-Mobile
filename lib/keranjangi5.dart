...
class KeranjangI5Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI5Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI5PageState createState() => _KeranjangI5PageState();
}

class _KeranjangI5PageState extends State<KeranjangI5Page> {
  int totalItems = 0;
  double totalPrice = 0;
