...
class KeranjangI6Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI6Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI6PageState createState() => _KeranjangI6PageState();
}

class _KeranjangI6PageState extends State<KeranjangI6Page> {
  int totalItems = 0;
  double totalPrice = 0;
