...
class KeranjangI7Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI7Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI7PageState createState() => _KeranjangI7PageState();
}

class _KeranjangI7PageState extends State<KeranjangI7Page> {
  int totalItems = 0;
  double totalPrice = 0;
