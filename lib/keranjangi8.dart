...
class KeranjangI8Page extends StatefulWidget {
  final int quantityy;
  final int totalPricee;

  KeranjangI8Page({required this.quantityy, required this.totalPricee});

  @override
  _KeranjangI8PageState createState() => _KeranjangI8PageState();
}

class _KeranjangI8PageState extends State<KeranjangI8Page> {
  int totalItems = 0;
  double totalPrice = 0;
